...
import { FaXTwitter, FaGlobe, FaLinkedinIn } from 'react-icons/fa6';

const Footer = () => {
    return (
        <>
        
        <section className="bg-[#141414] text-white px-6 md:px-16 py-22 rounded-3xl max-w-[1300px] mx-5 xl:mx-auto">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-10 text-sm">
                    <div>
                        <h4 className="font-bold mb-3 text-xl">Compare</h4>
                        <ul className="space-y-2 text-gray-300">
                            <li>vs Productboard</li>
                            <li>vs Notion</li>
                            <li>vs Airfocus</li>
                            <li>vs Harvestr</li>
                            <li>vs Dovetail</li>
                    ...
                    <div>
                        <h4 className="font-bold mb-3 text-xl">Explore</h4>
                        <ul className="space-y-2 text-gray-300">
                            <li>Integrations</li>
                            <li>Docs</li>
                            <li>API</li>
                    ...
                    <div>
                        <h4 className="font-bold mb-3 text-xl">Company</h4>
                        <ul className="space-y-2 text-gray-300">
                            <li>Manifesto</li>
                            <li>Press Kit</li>
                            <li>Status</li>
                    ...
                    <div>
                        <h4 className="font-bold mb-3 text-xl">Legal</h4>
                        <ul className="space-y-2 text-gray-300">
